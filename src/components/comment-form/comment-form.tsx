      ...
      <form action={formAction}>
        ...
        <div className="flex gap-3">
          <div className="w-9 h-9 rounded-full bg-gray-200 flex items-center justify-center flex-shrink-0 mt-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#9ca3af" strokeWidth="2">
        ...
        <div className="border-t border-gray-100 mt-3 pt-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 text-gray-400">
            <button type="button" className="hover:text-gray-600 transition-colors cursor-pointer">
        ...
        {/* success message */}
        {state.type === "success" && (
          <p className="mt-2 text-xs text-green-600">Comment posted successfully!</p>
        )}
      </form>
    </div>
  );
